...
public class PlayerThread extends Thread {
    ...
    private String strVideo = Environment.getExternalStorageDirectory() + "/test/H265_1080.mp4";

    public PlayerThread(Surface surface) {
        this.surface = surface;
    }
    public void setDataSourcePath(String sourcePath){
        this.strVideo = sourcePath;
    }
